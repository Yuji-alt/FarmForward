...
class LoginActivity : AppCompatActivity(), LoginView {
    ...
    private val requestPermissionLauncher = registerForActivityResult(
        ...
        if (isGranted) Log.d("LoginActivity", "Location Permission granted")
        else Log.d("LoginActivity", "Location Permission denied")
    }
    ...
    override fun navigateToMain() {
        ...
        val hasSeenTutorial = prefs.getBoolean("has_seen_onboarding", false)

        if (!hasSeenTutorial) {
            val intent = Intent(this, com.example.farmforward.utils.onBoarding.OnboardingActivity::class.java)
    ...
    override fun showForgotPasswordDialog() {
        ...
        btnSend.setOnClickListener {
            controller.sendPasswordReset(etEmail.text.toString().trim())
            dialog.dismiss()
        }
