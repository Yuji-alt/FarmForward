...
class GardenDisplayController(private val context: Context, private val container: LinearLayout) {
    ...
    fun displayCrops(crops: List<CropEntity>, onItemClick: (CropEntity) -> Unit) {
        ...
        for (crop in crops) {
            ...
            val imgCrop = itemView.findViewById<ImageView>(R.id.imgCrop) // Ensure this ID exists in XML
